...
import { applyJob, fetchJobs, fetchJobsApplied, fetchRecruiterDetails } from "../../service/UserService";
...
const JobsApplied = () => {
  ...
  const fetchJob = async () => {
    if (!token) return;
    try {
      const res = await fetchJobsApplied(page, 10, token);
      if (res.status === 200) {
        console.log(res)
  ...
  return (
    <div className="container mt-4">
      ...
      {/* Pagination */}
      {jobs && <div className="d-flex justify-content-between align-items-center mt-4" style={{ paddingTop: "200px" }}>
        <button
